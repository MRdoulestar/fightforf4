...
var attackRepeatTime : float = 2; // delay between attacks when within range
var anim : GameObject;
...
function Update () {
	...
	if (chasing) {	
		...
		//Zombie2.GetComponent.<Rigidbody>().MovePosition(Zombie2.GetComponent.<Rigidbody>().position+Zombie2.GetComponent.<Rigidbody>().position * moveSpeed * Time.deltaTime);
