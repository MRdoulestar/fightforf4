...
public class vrnew : MonoBehaviour
{
	...
	protected void Update()
	{
		...
		transform.rotation = Quaternion.Lerp(transform.rotation, cameraBase * (ConvertRotation(referanceRotation * Input.gyro.attitude) * GetRotFix()), lowPassFilterFactor);
